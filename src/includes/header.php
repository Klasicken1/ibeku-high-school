...
<head>
  ...
  <!-- Open Graph (for WhatsApp / social sharing previews) -->
  ...
  <?php if (!empty($pageCss)): ?>
    <link rel="stylesheet" href="/assets/css/pages/<?php echo htmlspecialchars($pageCss); ?>.css"/>
  <?php endif; ?>
...
<nav class="nav">
  <div class="nav__inner">
    ...
    <!-- Logo -->
    <!-- Phase 2: replace .nav__crest with <img> once logo is ready -->
    ...
    <ul class="nav__menu" id="navMenu" role="menubar">
      ...
      <li class="nav__item nav__item--has-drop <?php echo ($currentPage === 'about') ? 'nav__item--active' : ''; ?>">
        ...
        <div class="nav__dropdown" role="menu">
          <a href="/about.php"            class="nav__dropdown-link">About the School</a>
          <a href="/about.php#history"    class="nav__dropdown-link">History of the School</a>
          <a href="/about.php#vision"     class="nav__dropdown-link">Vision &amp; Mission</a>
          <a href="/about.php#anthem"     class="nav__dropdown-link">School Anthem</a>
          <a href="/about.php#rules"      class="nav__dropdown-link">Rules &amp; Regulations</a>
          <div class="nav__dropdown-divider"></div>
          <a href="/about.php#principal-ss" class="nav__dropdown-link">SS Principal's Message</a>
          <a href="/about.php#principal-js" class="nav__dropdown-link">JS Principal's Message</a>
        </div>
      </li>

      <!-- Academics dropdown -->
      <li class="nav__item nav__item--has-drop <?php echo ($currentPage === 'academics') ? 'nav__item--active' : ''; ?>">
        <a href="/academics.php" class="nav__link">
          Academics <span class="nav__chev" aria-hidden="true"></span>
        </a>
        <div class="nav__dropdown" role="menu">
          <a href="/academics.php#departments" class="nav__dropdown-link">Departments &amp; Subjects</a>
          <a href="/academics.php#timetable"   class="nav__dropdown-link">School Timetable</a>
          <a href="/academics.php#staff"       class="nav__dropdown-link">Staff Directory</a>
          <a href="/academics.php#clubs"       class="nav__dropdown-link">Clubs &amp; Societies</a>
          <a href="/academics.php#awards"      class="nav__dropdown-link">Competitions &amp; Awards</a>
          <a href="/academics.php#resources"   class="nav__dropdown-link">Learning Resources</a>
        </div>
      </li>
      ...
      <li class="nav__item nav__item--has-drop <?php echo ($currentPage === 'students') ? 'nav__item--active' : ''; ?>">
        ...
        <div class="nav__dropdown" role="menu">
          <a href="/results.php"               class="nav__dropdown-link">Check Results Online</a>
          <a href="/students.php#prefects"     class="nav__dropdown-link">Prefects &amp; Student Leaders</a>
          <a href="/hall-of-fame.php"          class="nav__dropdown-link">Hall of Fame</a>
          <a href="/students.php#alumni"       class="nav__dropdown-link">Alumni / Old Students</a>
          <a href="/students.php#sponsorship"  class="nav__dropdown-link">Scholarships &amp; Support</a>
        </div>
      </li>
      ...
      <li class="nav__item nav__item--has-drop <?php echo ($currentPage === 'news') ? 'nav__item--active' : ''; ?>">
        ...
        <div class="nav__dropdown" role="menu">
          <a href="/news.php"    class="nav__dropdown-link">News &amp; Blog</a>
          <a href="/events.php"  class="nav__dropdown-link">Events</a>
          <a href="/gallery.php" class="nav__dropdown-link">Gallery</a>
        </div>
      </li>

      <li class="nav__item <?php echo ($currentPage === 'admissions') ? 'nav__item--active' : ''; ?>">
        <a href="/admissions.php" class="nav__link">Admissions</a>
      </li>
      ...
      <li class="nav__item nav__item--results">
        <a href="/results.php" class="nav__link">Check Results</a>
      </li>

      <li class="nav__item nav__item--cta">
        <a href="/admissions.php" class="nav__link">Apply Now</a>
      </li>
...
<div class="ann-bar" id="annBar" role="alert" aria-live="polite">
  ...
  <span>
    ...
    <a href="/results.php">Check your results →</a>
  </span>
