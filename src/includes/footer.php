  ...
  <div class="footer__inner">
    <div class="footer__grid">
      ...
      <div class="footer__col">
        <h4>Contact</h4>
        <ul>
          <li>📍 <?php echo htmlspecialchars($_site['school_address']); ?></li>
          <li><a href="tel:<?php echo htmlspecialchars(preg_replace('/\s+/', '', $_site['school_phone'])); ?>">📞 <?php echo htmlspecialchars($_site['school_phone']); ?></a></li>
          <li><a href="mailto:<?php echo htmlspecialchars($_site['school_email']); ?>">✉ <?php echo htmlspecialchars($_site['school_email']); ?></a></li>
        </ul>
      </div>
    </div>
