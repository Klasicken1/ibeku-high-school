...
/* ── Ensure staff_messages has all needed columns ── */
try {
    $pdo->exec(
    ...
    if ($action === 'send') {
        ...
        if ($recipientId <= 0) {
            ...
            try {
                ...
                $message = 'Message sent successfully.'; $messageType = 'success';
                $view = 'sent';
            } catch (PDOException $e) {
        ...
        $msgId = (int) ($_POST['msg_id'] ?? 0);
        if ($msgId > 0) {
            /* Only allow deleting own messages (sent or received) */
            $pdo->prepare(
  ...
  <div class="admin-content">
    <div class="admin-content__inner">
      ...
      <div class="msg-layout">
        ...
        <div>
          <div class="msg-nav">
            <a href="messages.php?view=inbox" class="msg-nav__btn <?php echo $view === 'inbox' ? 'msg-nav__btn--active' : ''; ?>">
              📥 Inbox
              <?php if ($unreadCount > 0): ?>
              <span class="msg-nav__badge"><?php echo $unreadCount; ?></span>
              <?php endif; ?>
            </a>
            <a href="messages.php?view=sent" class="msg-nav__btn <?php echo $view === 'sent' ? 'msg-nav__btn--active' : ''; ?>">
              📤 Sent
            </a>
            <a href="messages.php?view=compose" class="msg-nav__btn <?php echo $view === 'compose' ? 'msg-nav__btn--active' : ''; ?>">
              ✏️ Compose
            </a>
          </div>
        </div>
        ...
        <div class="msg-panel">
          ...
          <div class="msg-open">
            ...
            <div class="msg-open__actions">
              ...
              <?php endif; ?>
              <a href="messages.php?view=<?php echo $openMsg['sender_id'] === $admin['id'] ? 'sent' : 'inbox'; ?>"
                 class="btn-back">← Back to <?php echo $openMsg['sender_id'] === $admin['id'] ? 'Sent' : 'Inbox'; ?></a>
            ...
            <li>
              <a href="messages.php?open=<?php echo $m['id']; ?>&view=sent" class="msg-item">
                ...
                <div class="msg-item__body">
                  ...
                  <div class="msg-item__preview"><?php echo htmlspecialchars(mb_substr($m['body'], 0, 60)) . '…'; ?></div>
                </div>
          ...
          <div class="msg-panel__header">
            <span class="msg-panel__title">
              Inbox
              <?php if ($unreadCount > 0): ?>
              <span style="background:#3d1a6e;color:#fff;font-size:11px;padding:2px 8px;border-radius:20px;margin-left:6px"><?php echo $unreadCount; ?> unread</span>
              <?php endif; ?>
            </span>
          ...
          <div class="empty-state">
            Your inbox is empty.
            <br/><a href="messages.php?view=compose" style="color:#4a90d9;margin-top:8px;display:inline-block">Send the first message →</a>
          </div>
          <?php else: ?>
          <ul class="msg-list">
