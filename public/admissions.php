<?php
/* ============================================================
   IBEKU HIGH SCHOOL â€” ADMISSIONS PAGE
   File: public/admissions.php
   ============================================================ */

$pageTitle   = 'Admissions â€” Ibeku High School, Umuahia';
...
<div style="max-width:600px;margin:80px auto;text-align:center;padding:40px 24px;background:#fff;border:1px solid #e8e6f0;border-radius:16px;font-family:'DM Sans',sans-serif">
  ...
  <div style="margin-top:20px;display:flex;flex-direction:column;gap:8px;align-items:center;font-size:14px;color:#6b6b80">
    <span>ðŸ“ž <?php echo htmlspecialchars($_site['school_phone']); ?></span>
    <span>âœ‰ <?php echo htmlspecialchars($_site['school_email']); ?></span>
    <span>ðŸ“ <?php echo htmlspecialchars($_site['school_address']); ?></span>
  </div>
  <p style="margin-top:16px">
    <a href="<?php echo BASE_PATH; ?>contact.php" style="color:#4a90d9">Contact the school office â†’</a>
  </p>
</div>
<?php
...
<section class="why-section" id="why">
  <div class="why-section__inner wrap">
    ...
    <div class="why-grid">
      ...
      <div class="why-card reveal">
        <span class="why-card__icon" aria-hidden="true">ðŸŽ­</span>
        <h3>Holistic Development</h3>
        <p>15+ clubs and societies, sports teams, cultural events, and competitions developing every dimension of the student.</p>
      </div>
      <div class="why-card reveal">
        <span class="why-card__icon" aria-hidden="true">âš–ï¸</span>
        <h3>Discipline &amp; Values</h3>
        <p>A school culture built on integrity, discipline, and strong moral values â€” the foundation every student needs for life.</p>
      </div>
      <div class="why-card reveal">
        <span class="why-card__icon" aria-hidden="true">ðŸŒ</span>
        <h3>Strong Alumni Network</h3>
        <p>15,000+ proud alumni across medicine, law, engineering, public service, and business â€” an invaluable lifelong network.</p>
      </div>
    </div>
    ...
    <div class="why-text reveal">
      ...
      <p>Our graduates go on to the best universities in Nigeria and across the world â€” not just because of their academic scores, but because of the character, discipline, and resilience they develop within our walls.</p>
    ...
    <div class="requirements-grid">
      ...
      <div class="req-card reveal">
        <div class="req-card__header req-card__header--jss">
          <span class="req-card__icon" aria-hidden="true">ðŸ«</span>
          <h3>JSS 1 Entry</h3>
          <p>Junior Secondary School â€” Year 1</p>
        </div>
      ...
      <div class="req-card reveal">
        <div class="req-card__header req-card__header--sss">
          <span class="req-card__icon" aria-hidden="true">ðŸŽ“</span>
          <h3>SSS 1 Entry</h3>
          <p>Senior Secondary School â€” Year 1</p>
        </div>
        <div class="req-card__body">
          <h4>Age Requirement</h4>
          <ul>
  ...
  <div class="apply-steps-section__inner wrap">
    ...
    <div class="steps-grid">
      <div class="step-card reveal">
        ...
        <span class="step-card__icon" aria-hidden="true">ðŸ“</span>
      ...
      <div class="step-card reveal">
        ...
        <p>Return the completed application form with all required documents â€” certificates, birth certificate, report card, and 4 passport photographs.</p>
      </div>
      <div class="step-card reveal">
        <div class="step-card__num">3</div>
        <span class="step-card__icon" aria-hidden="true">âœï¸</span>
      ...
      <div class="step-card reveal">
        ...
        <span class="step-card__icon" aria-hidden="true">ðŸŽ‰</span>
  ...
  <div class="fees-dates-section__inner wrap">
    ...
    <div class="fees-card reveal">
      <div class="fees-card__header">
        <h3>School Fees</h3>
        <p><?php echo htmlspecialchars($_site['current_session']); ?> Academic Session â€” indicative figures</p>
      </div>
      <div class="fees-table">
        <?php
        $fees = [
          ['Application Form',              'â‚¦2,000'],
          ['Acceptance Fee (new students)', 'â‚¦5,000'],
          ['Tuition â€” JSS (per term)',      'â‚¦[Amount]'],
          ['Tuition â€” SSS (per term)',      'â‚¦[Amount]'],
          ['Levies &amp; Development',      'â‚¦[Amount]'],
          ['PTA Dues (per session)',         'â‚¦[Amount]'],
        ];
        foreach ($fees as $fee): ?>
        <div class="fees-row">
    ...
    <div class="dates-card reveal">
      ...
      <div class="dates-table">
        ...
        $dates = [
          ...
          ['Application Deadline â€” JSS 1',  'March'],
          ['Application Deadline â€” SSS 1',  'March'],
          ['Entrance Examination',          'April'],
          ['Results Announcement',          'April'],
          ['Acceptance &amp; Registration', 'May'],
          ['Resumption â€” New Students',     'September'],
        ];
...
<!-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
     APPLICATION FORM â€” wired to submit_admission.php
     â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
<section class="application-form-section" id="apply-now">
  <div class="application-form-section__inner wrap">
    ...
    <div class="application-form-section__info reveal">
      ...
      <p>You may also visit us in person at the school office during working hours â€” Monday to Friday, 8:00 AM to 3:00 PM.</p>

      <div class="contact-options">
        <div class="contact-option">
          <span class="contact-option__icon" aria-hidden="true">ðŸ“</span>
        ...
        <div class="contact-option">
          <span class="contact-option__icon" aria-hidden="true">ðŸ“ž</span>
          <div class="contact-option__text">
        ...
        <div class="contact-option">
          <span class="contact-option__icon" aria-hidden="true">âœ‰ï¸</span>
          <div class="contact-option__text">
        ...
        <div class="contact-option">
          ...
          <div class="contact-option__text">
            ...
            <span><?php echo htmlspecialchars($_site['school_hours'] ?: 'Monday â€“ Friday, 8:00 AM â€“ 3:00 PM'); ?></span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="faq-list">
      ...
      $faqs = [
        ...
        ['q' => 'Is there an entrance examination?',
         'a' => 'Yes. All applicants â€” for both JSS 1 and SSS 1 entry â€” are required to sit a written entrance examination in English Language and Mathematics. SSS 1 applicants also sit Basic Science. Candidates are offered places based on their examination performance.'],
...
<script>
/* â”€â”€ Admissions form submission â”€â”€ */
function submitAdmissionForm() {
  ...
  fetch('<?php echo API_PATH; ?>submit_admission.php', { method: 'POST', body: fd })
    ...
    .finally(function () {
      btn.textContent = 'Submit Admissions Enquiry â†’';
      btn.disabled    = false;
    });
}
